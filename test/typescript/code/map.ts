 ...
 * Test definition
 */
declare type Value = ObjectMap<number>
declare type DefinedValue = ObjectMap<number>
declare type BinderType<T> = MapBinder<T>

declare type ValueBinder = BinderType<number>
declare type ItemBinder = BinderType<number>
